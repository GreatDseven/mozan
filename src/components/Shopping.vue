    ...
    <div class="shopcart">
      <div class="inner">
        <div class="top">
          ...
          <ul>
            <li>
              <router-link to="/shopcart" :class="$route.fullPath==='/shopcart' ? 'active':'' ">购物车</router-link>
            </li>
            <li>
              <router-link to="/order" :class="$route.fullPath==='/order' ? 'active':'' ">填写订单</router-link>
            </li>
            <li>
              <router-link to="/pay" :class="$route.fullPath==='/pay' ? 'active':'' ">付款，购买成功</router-link>
            </li>
          </ul>
        </div>
        <div class="content" v-if="order">
          <div class="goods-bar">
            <div class="allchecked">
              <label class="text" @click="checkedAll(order.checked)">
          ...
          <div class="goods-submit">
            <div class="left">
              <div class="allchecked">
                <input type="checkbox" id="allsubmit" class="checkbox" />
                <label for="allsubmit" class="text">
                  <span>√</span>
                </label>
                <label for="allsubmit">全选</label>
              </div>
              <div class="delect">
...
.shopcart .top > ul > li.active {
  border-bottom: 5px solid #000;
  font-weight: bold;
}
.shopcart .top > ul > li > a {
  font-size: 20px;
  color: #000;
}
...
.shopcart .inner .goods-submit .left .allchecked > label:nth-child(3) {
